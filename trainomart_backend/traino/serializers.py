...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Course
        fields = ['id', 'course_name', 'slug', 'course_image', 'created_at', 'course_content', 'description', 'you_will_learn_list', 'lessons', 'prerequisites', 'category', 'duration', 'language', 'skill_level', 'price', 'orignal_price', 'last_updated', 'tags', 'is_featured', 'faq', 'meta_title', 'meta_description', 'canonical_tag', 'buy_button_id']
