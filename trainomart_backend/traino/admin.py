...
class SignUpAdmin(admin.ModelAdmin):
    list_display = ('id', 'username', 'email', 'phone_number', 'role', 'alternative_phone_number', 'alternative_email', 'company', 'experience', 'user_image')  # Columns to show
...
class ClassAdmin(admin.ModelAdmin):
    list_display = ('id', 'course', 'instructor', 'class_date', 'class_joining_link', 'display_student_payment_status')
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('course_name', 'category', 'orignal_price', 'price', 'duration', 'is_featured', 'tags', 'last_updated', 'meta_title', 'meta_description', 'slug', 'buy_button_id')
...
class BlogAdmin(admin.ModelAdmin):
    list_display = ('blog_title', 'blog_image', 'category', 'slug', 'meta_title', 'meta_description')
    search_fields = ('blog_title', 'category')
    ordering = ('blog_title',)
    fields = ('blog_title', 'slug', 'blog_image', 'category', 'blog_data', 'meta_title', 'meta_description')
